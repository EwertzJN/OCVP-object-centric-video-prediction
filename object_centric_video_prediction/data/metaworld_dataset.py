...
PATH = "/home/nfs/inf6/data/datasets/EwertzData/metaworld_datasets"


class MetaWorldDataset(RobotDataset):

  def __init__(self, mode, dataset_name, ep_len=250, sample_length=10, random_start=True, img_size=(64, 64)):
    """
    Dataset Initializer
    """
